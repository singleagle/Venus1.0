...
public class MongoClientManager extends AbstractClientManager {
    ...
    protected Client createClient(String clientId, char[] clientSecret,
        ...
        BasicDBObject client = new BasicDBObject("_id", Integer.valueOf(clientId));
    ...
    public void deleteClient(String id) {
    	clients.findAndRemove(new BasicDBObject("_id", Integer.valueOf(id)));
    }

    @Override
    public Client findById(String id) {
        DBObject client = clients.findOne(new BasicDBObject("_id", Integer.valueOf(id)));
        if (client == null) {
            return null;
        }
        return new MongoClient(client);
